...
class LimboChannelAutoGreet(onmemberjointask.OnMemberJoinTask):
	...
	async def run(self, member, client):
		...
		time.sleep(1)
		await limbochannel.send(f"Welcome to the Immigration Center {member.mention}. Please stand by shortly while one of our staff members review your documents.")
