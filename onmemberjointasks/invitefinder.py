...
class InviteFinder(onmemberjointask.OnMemberJoinTask):
    ...
    async def run(self, member, client):
        print(
            "do something")  # i have decided to simply add the InviteManager bot to do this for me, unfortunately, the InviteManager bot is a bloated mess that WONT SHUT UP
