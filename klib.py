# my version of https://github.com/reteps/kbot/blob/master/klib.py
...
class Kahoot:
    def __init__(self, pin, username, loop):
        self.pin = pin
        ...
        self.loop = loop  # event loop not in original
    ...
    def startGame(self):
        ...
        # await self._play()
        # asyncio.run(self._play) # this kills it
        asyncio.new_event_loop().run_until_complete(self._play)
            ...
            async for rawMessage in client:
                ...
                if 'id' in message:
                    ...
                    # print(f'ANSWERS RECEIVED')
                        ...
                        await client.close()
                        # exit() # WHY THE FUCK DOES THIS LIBRARY SHUT DOWN THE WHOLE FUCKING PROGRAM WHAT THE FUCK
                        return  # WHY COULDN'T IT JUST DO THIS WHAT THE FUCK IS WRONG WITH THE ORIGINAL AUTHOR WTF
    ...
    @_check_auth
    # async
    def searchQuiz(self, name, exceptedAnswers=None, maxCount=20):  # WHAT ABOUT THIS MAKES IT ASYNCRONOUS ?!?!?! WTF
